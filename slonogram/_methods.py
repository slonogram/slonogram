...
# generated at: 2023-12-12 10:46:14.402937
...
class _Methods:
    ...
    async def get_updates(
        ...
        Telegram docs: https://core.telegram.org/bots/api#getupdates
        ...
        return self._retort.load(
            await self._session.call_method(
                "getUpdates",
                args,
            ),
            list[Update],
    ...
    async def set_webhook(
        ...
        if max_connections is not None:
            args["max_connections"] = str(max_connections)
        if allowed_updates is not None:
            args["allowed_updates"] = str(allowed_updates)
        if drop_pending_updates is not None:
            args["drop_pending_updates"] = str(drop_pending_updates)
        if secret_token is not None:
            args["secret_token"] = str(secret_token)
        return self._retort.load(
            await self._session.call_method(
                "setWebhook",
                args,
    ...
    async def delete_webhook(self, drop_pending_updates: bool | None = None) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#deletewebhook
    ...
    async def copy_message(
        ...
        if caption_entities is not None:
            args["caption_entities"] = caption_entities
        if disable_notification is not None:
            args["disable_notification"] = disable_notification
        if protect_content is not None:
            args["protect_content"] = protect_content
    ...
    async def send_photo(
        ...
        if isinstance(photo, IOBase):
            files["photo"] = photo
        if message_thread_id is not None:
            args["message_thread_id"] = str(message_thread_id)
        if caption is not None:
            args["caption"] = str(caption)
        if parse_mode is not None:
            args["parse_mode"] = str(parse_mode)
        if caption_entities is not None:
            args["caption_entities"] = str(caption_entities)
        if has_spoiler is not None:
            args["has_spoiler"] = str(has_spoiler)
        if disable_notification is not None:
            args["disable_notification"] = str(disable_notification)
        if protect_content is not None:
            args["protect_content"] = str(protect_content)
        if reply_to_message_id is not None:
            args["reply_to_message_id"] = str(reply_to_message_id)
        if allow_sending_without_reply is not None:
            args["allow_sending_without_reply"] = str(allow_sending_without_reply)
        if reply_markup is not None:
    ...
    async def send_document(
        ...
        if disable_content_type_detection is not None:
            args["disable_content_type_detection"] = str(disable_content_type_detection)
        if disable_notification is not None:
            args["disable_notification"] = str(disable_notification)
        if protect_content is not None:
            args["protect_content"] = str(protect_content)
    ...
    async def send_video(
        ...
        if supports_streaming is not None:
            args["supports_streaming"] = str(supports_streaming)
        if disable_notification is not None:
            args["disable_notification"] = str(disable_notification)
        if protect_content is not None:
            args["protect_content"] = str(protect_content)
    ...
    async def send_animation(
        ...
        Telegram docs: https://core.telegram.org/bots/api#sendanimation
    ...
    async def send_poll(
        ...
        if explanation_entities is not None:
            args["explanation_entities"] = explanation_entities
    ...
    async def ban_chat_member(
        ...
        Telegram docs: https://core.telegram.org/bots/api#banchatmember
    ...
    async def restrict_chat_member(
        ...
        Telegram docs: https://core.telegram.org/bots/api#restrictchatmember
    ...
    async def set_chat_permissions(
        ...
        Telegram docs: https://core.telegram.org/bots/api#setchatpermissions
    ...
    async def create_chat_invite_link(
        ...
        Telegram docs: https://core.telegram.org/bots/api#createchatinvitelink
    ...
    async def set_chat_photo(self, chat_id: int | str, photo: BinaryIO) -> bool:
    ...
    async def delete_chat_photo(self, chat_id: int | str) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#deletechatphoto
    ...
    async def set_chat_description(
        ...
        Telegram docs: https://core.telegram.org/bots/api#setchatdescription
    ...
    async def leave_chat(self, chat_id: int | str) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#leavechat
    ...
    async def get_chat(self, chat_id: int | str) -> Chat:
        ...
        Telegram docs: https://core.telegram.org/bots/api#getchat
    ...
    async def get_chat_administrators(self, chat_id: int | str) -> list[ChatMember]:
        ...
        Telegram docs: https://core.telegram.org/bots/api#getchatadministrators
    ...
    async def get_chat_member_count(self, chat_id: int | str) -> int:
        ...
        Telegram docs: https://core.telegram.org/bots/api#getchatmembercount
    ...
    async def get_forum_topic_icon_stickers(
        ...
        Telegram docs: https://core.telegram.org/bots/api#getforumtopiciconstickers
    ...
    async def close_forum_topic(
        ...
        Telegram docs: https://core.telegram.org/bots/api#closeforumtopic
    ...
    async def close_general_forum_topic(self, chat_id: int | str) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#closegeneralforumtopic
    ...
    async def reopen_general_forum_topic(self, chat_id: int | str) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#reopengeneralforumtopic
    ...
    async def hide_general_forum_topic(self, chat_id: int | str) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#hidegeneralforumtopic
    ...
    async def unhide_general_forum_topic(self, chat_id: int | str) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#unhidegeneralforumtopic
    ...
    async def unpin_all_general_forum_topic_messages(self, chat_id: int | str) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#unpinallgeneralforumtopicmessages
    ...
    async def get_my_name(self, language_code: str | None = None) -> BotName:
        ...
        Telegram docs: https://core.telegram.org/bots/api#getmyname
    ...
    async def get_my_description(
        ...
        Telegram docs: https://core.telegram.org/bots/api#getmydescription
    ...
    async def get_my_short_description(
        ...
        Telegram docs: https://core.telegram.org/bots/api#getmyshortdescription
    ...
    async def get_chat_menu_button(self, chat_id: int | None = None) -> MenuButton:
        ...
        Telegram docs: https://core.telegram.org/bots/api#getchatmenubutton
    ...
    async def delete_message(self, chat_id: int | str, message_id: int) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#deletemessage
    ...
    async def get_sticker_set(self, name: str) -> StickerSet:
        ...
        Telegram docs: https://core.telegram.org/bots/api#getstickerset
    ...
    async def upload_sticker_file(
        self, user_id: int, sticker: BinaryIO, sticker_format: str
    ) -> File:
        ...
        args: dict[str, Any] = {
            "user_id": str(user_id),
            "sticker_format": str(sticker_format),
        }
        files: dict[str, BinaryIO] = {}
        files["sticker"] = sticker
        return self._retort.load(
    ...
    async def set_sticker_position_in_set(self, sticker: str, position: int) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#setstickerpositioninset
    ...
    async def delete_sticker_from_set(self, sticker: str) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#deletestickerfromset
    ...
    async def set_sticker_set_title(self, name: str, title: str) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#setstickersettitle
    ...
    async def set_sticker_set_thumbnail(
        self, name: str, user_id: int, thumbnail: BinaryIO | str | None = None
    ) -> bool:
        """Use this method to set the thumbnail of a regular or mask sticker set. The format of the thumbnail file must match the format of the stickers in the set. Returns True on success.
        Telegram docs: https://core.telegram.org/bots/api#setstickersetthumbnail
    ...
    async def delete_sticker_set(self, name: str) -> bool:
        ...
        Telegram docs: https://core.telegram.org/bots/api#deletestickerset
    ...
    async def send_invoice(
        ...
        if suggested_tip_amounts is not None:
            args["suggested_tip_amounts"] = suggested_tip_amounts
    ...
    async def set_passport_data_errors(
        ...
        Telegram docs: https://core.telegram.org/bots/api#setpassportdataerrors
